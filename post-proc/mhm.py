...
class MHM(object):
    ...
    def __init__(self, model_path, file_name="mhm.nml", rel_path_name=False):
        ...
        self.cellsize_ratio["L1"] = (
            float(self.nml["resolution_Hydrology(1)"]) / self.cellsize["L0"]
        )
    ...
    def upscale_L1_data(self, L0_array, flag):
        ...
        L1_array = np.ma.array(
            np.zeros((self.nrows["L1"], self.ncols["L1"])), mask=self.mask["L1"]
        )
