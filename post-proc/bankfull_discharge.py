...
def get_cmdline_args(default_return_period):
    parser = argparse.ArgumentParser(
        description="Calculate the river discharge at bankfull conditions."
    )
    parser.add_argument(
        "ncin_path", help="The path of the mRM NetCDF file with the discharge data"
    )
    parser.add_argument("ncout_path", help="The path of the output NetCDF file")
    parser.add_argument(
        "-p",
        "--return_period",
        type=float,
        help="The return period of the flood, default: {:1} years".format(
