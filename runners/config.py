...
WORKING_DIR = "/workspace/test_domain_4"  # working directory for all modules
DOMAIN_FILE = "/workspace/test_domain_4/input/domain/NuecesRiver.geojson"  # watershed boundary for all modules
...
START_DATE      = "2017-04-01"  # forcing/simulation start; earliest date mHM may draw spin-up from
END_DATE        = "2026-07-31"  # forcing/simulation and evaluation end.
EVAL_START_DATE = "2017-04-01"  # calibration scoring starts here; keep FIXED so warm-up length changes don't move the scored window
