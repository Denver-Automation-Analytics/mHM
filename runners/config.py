...
START_DATE      = "2026-07-01"  # forcing/simulation start; earliest date mHM may draw spin-up from
END_DATE        = "2026-08-14"  # forcing/simulation and evaluation end.
EVAL_START_DATE = "2026-07-01"  # calibration scoring starts here; keep FIXED so warm-up length changes don't move the scored window
