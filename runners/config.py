...
START_DATE      = "2016-10-01"  # forcing/simulation start; earliest date mHM may draw spin-up from
END_DATE        = "2026-07-31"  # forcing/simulation and evaluation end
EVAL_START_DATE = "2024-01-01"  # calibration scoring starts here; keep FIXED so warm-up length changes don't move the scored window
...
OPTI_OBJECTIVE  = "multi_kge"  # mod19 calibration objective: "nse" | "lnnse" | "nse_lnnse" | "kge" | "multi_kge"
